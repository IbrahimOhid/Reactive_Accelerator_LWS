  ...
  return (
    <section className="bg-white flex items-center justify-center px-4 py-16">
      <div
        ...
        key={id}
      >
        <div className="border border-zinc-200 hover:border-zinc-300 transition-colors rounded-xl p-2 flex flex-col w-46">
          {/* Product Image */}
          ...
          <button onClick={handleAddToCart} className="bg-green-400 hover:bg-green-500 font-bold cursor-pointer px-3 mt-3 py-0.5 rounded-xl">
            Add To Cart
          </button>
        </div>
      </div>
