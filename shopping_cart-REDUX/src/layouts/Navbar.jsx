    ...
    <nav className="sticky top-0 z-50 w-full border-b border-slate-100 bg-white backdrop-blur-xl">
      <div className="mx-auto flex h-[72px] max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <ul className="hidden items-center gap-8 lg:flex">
          <Link to={"/home"} className="group flex cursor-pointer items-center gap-2 text-sm font-medium text-slate-600 transition-all duration-300 hover:text-sky-600">
            <AiOutlineFire className="text-[20px] transition-all duration-300 group-hover:scale-110 group-hover:text-sky-600" />
            Home
          </Link>

          <Link to={"/product"} className="group flex cursor-pointer items-center gap-2 text-sm font-medium text-slate-600 transition-all duration-300 hover:text-sky-600">
            <BiSupport className="text-[20px] transition-all duration-300 group-hover:scale-110 group-hover:text-sky-600" />
            Products
          </Link>
          <Link to={"/addProduct"} className="group flex cursor-pointer items-center gap-2 text-sm font-medium text-slate-600 transition-all duration-300 hover:text-sky-600">
            <BiSupport className="text-[20px] transition-all duration-300 group-hover:scale-110 group-hover:text-sky-600" />
            Add Product
          </Link>
        </ul>
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          {/* CART */}
          <button className="group relative flex h-11 w-11 items-center justify-center rounded-2xl border border-slate-200 bg-white transition-all duration-300 hover:border-sky-500/40 hover:bg-slate-50 hover:shadow-sm">
      ...
      >
        <div className="mx-auto flex max-w-7xl flex-col gap-2 px-4 py-5 sm:px-6">
          {/* HOME */}
          <Link to={"/home"} className="flex items-center gap-3 rounded-2xl border border-transparent bg-slate-50 px-4 py-4 text-left text-sm font-medium text-slate-700 transition-all duration-300 hover:border-sky-500/30 hover:bg-white hover:shadow-md">
